        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeywordId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleKeywords", x => new { x.ArticleId, x.KeywordId });
                    table.ForeignKey(
                        name: "FK_ArticleKeywords_Articles_ArticleId1",
                        column: x => x.ArticleId1,
                        principalTable: "Articles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ArticleKeywords_Keywords_KeywordId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Comments_AspNetUsers_PublisherId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleKeywords_ArticleId1",
                table: "ArticleKeywords",
                column: "ArticleId1");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleKeywords_KeywordId1",
                table: "ArticleKeywords",
                column: "KeywordId1");
